...
const MultiStepForm = () => {
    ...
    const submitFormData = async () => {
        ...
        try {
            const response = await axios.post('http://127.0.0.1:8000/api/insApp/', formData, {
                headers: {
    ...
    const renderStep = () => {
        switch (currentStep) {
            ...
            case 3:
                return <Step3 prevStep={prevStep} goToStep={goToStep} nextStep={nextStep} applicationType={formData.application_type} />;
            case 4:
                return <Step4 updateFormData={updateFormData} nextStep={nextStep} prevStep={prevStep} formData={formData} />;
            case 5:
